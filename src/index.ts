...
export const Config: Schema<Config> = Schema.object({
  ...
  verifierTools: Schema.boolean().default(true).description('Let the verifier use the evidence retrieval tools (tool loop multiplies token usage); off keeps the plain batched checklist verifier while evidence still drives cross-change detection and execver'),
